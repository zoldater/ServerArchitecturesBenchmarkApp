...
//                .setArchitectureType(NON_BLOCKING_ARCH)
                ...
                .setVariableArgumentData(new VariableArgumentDataBuilder().setArgumentTypeEnum(ARRAY_ELEMENTS).setFrom(1000).setTo(3000).setStep(100).createVariableArgumentData())
